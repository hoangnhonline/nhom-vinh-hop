...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Nhôm Vinh Hợp ADMIN</title>
	...
	<body>           
		...
		<div id="header">
			<!-- logo -->
			<div id="logo">
				<h1><a href="" title="NHÔM VINH HỢP Admin"><img src="../img/banner.png" alt="nhomvinhhop.com"  /></a></h1>
			</div>
			<!-- end logo -->
			<!-- user -->
			<ul id="user">				
		...
		<div id="content">
			...
			<div class="box">
                        ...
                        <?php	
                            ...
                            if ($com=="") include "blocks/baiviet/baiviet_list.php";
